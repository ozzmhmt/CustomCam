...
import com.ozzmhmt.customcamera.Manager.PendantManager;
import com.ozzmhmt.customcamera.Manager.MagicwandManager;
import com.ozzmhmt.customcamera.Manager.LayerManager;
import com.ozzmhmt.customcamera.Manager.HistoryManager;
...
public class PhotoEditionView2 extends android.support.v7.widget.AppCompatImageView {
    ...
    public Bitmap getPhoto(int size) {
        ...
        if(isFramed) {
            ...
            mphoto = Bitmap.createBitmap((int) (width * scale), (int) (height * scale), Bitmap.Config.ARGB_8888);
    ...
    private void openPendantControl() {
        ...
        msg.what = ShowPicActivity.OPEN_PENDANT_CONTROL;
    ...
    private void closePendantControl() {
        ...
        Message msg = new Message();
        msg.what = ShowPicActivity.CLOSE_PENDANT_CONTROL;
        parentHandler.sendMessage(msg);
    }
    //开启魔术棒控制条
    private void openMagicwandControl() {
        ...
        Message msg = new Message();
        msg.what = ShowPicActivity.OPEN_MAGICWAND_CONTROL;
        parentHandler.sendMessage(msg);
    }
    //关闭魔术棒控制条
    private void closeMagicwandControl() {
        ...
        Message msg = new Message();
        msg.what = ShowPicActivity.CLOSE_MAGICWAND_CONTROL;
        parentHandler.sendMessage(msg);
    }
